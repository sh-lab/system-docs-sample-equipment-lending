...
/**
 * 貸出申請却下処理の契約を定義する Command Service。
 *
 * <p>設計書:
 * <ul>
 *   <li>{@code docs/03_designs/services/command/HFP-EL-SCS011_reject-lending-request_service.md}</li>
 * </ul>
 */
public interface RejectLendingRequestCommandService
        extends CommandService<RejectLendingRequestCommandService.Request> {
