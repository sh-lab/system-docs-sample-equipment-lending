...
| `HFP-EL-V200_admin-mypage` | 管理者マイページ | 管理者が承認待ち申請一覧および返却確認待ち申請一覧を確認し、詳細確認画面へ遷移する起点とする。 | 管理者 | 管理業務起点、申請状況確認 | 遷移元：`login`、関連先：`管理者承認・却下・返却確認画面(V500)` | `docs/03_designs/ui/HFP-EL-V200_admin-mypage.md` | 設計済み画面である。 |
